...
__export(src_exports, {
  ...
  LoadSettingError: () => import_provider19.LoadSettingError,
  ...
  TooManyEmbeddingValuesForCallError: () => import_provider19.TooManyEmbeddingValuesForCallError,
...
var _a11;
var ToolCallRepairError = class extends import_provider12.AISDKError {
  constructor({
    cause,
    originalError,
    message = `Error repairing tool call: ${(0, import_provider12.getErrorMessage)(cause)}`
  }) {
...
var UnsupportedModelVersionError = class extends import_provider13.AISDKError {
  constructor(options) {
    super({
...
var _a12;
var UIMessageStreamError = class extends import_provider14.AISDKError {
  constructor({
    chunkType,
    chunkId,
    message
...
var _a13;
var InvalidDataContentError = class extends import_provider15.AISDKError {
  constructor({
    content,
    cause,
...
var _a14;
var InvalidMessageRoleError = class extends import_provider16.AISDKError {
  constructor({
    role,
...
var _a16;
var RetryError = class extends import_provider18.AISDKError {
  constructor({
    message,
    reason,
    errors
  ...
  static isInstance(error) {
    return import_provider18.AISDKError.hasMarker(error, marker16);
  }
};
_a16 = symbol16;
...
function getGlobalProvider() {
  var _a18;
  return (_a18 = globalThis.AI_SDK_DEFAULT_PROVIDER) != null ? _a18 : import_gateway.gateway;
}
...
// src/version.ts
var VERSION = true ? "6.0.48" : "0.0.0-test";
...
function convertToLanguageModelV3DataContent(content) {
  ...
  if (content instanceof URL && content.protocol === "data:") {
    ...
    if (dataUrlMediaType == null || base64Content == null) {
      throw new import_provider20.AISDKError({
...
async function standardizePrompt(prompt) {
  if (prompt.prompt == null && prompt.messages == null) {
    throw new import_provider22.InvalidPromptError({
      prompt,
...
function wrapGatewayError(error) {
  ...
  if (isProductionEnv) {
    return new import_provider23.AISDKError({
      name: "GatewayError",
...
async function _retryWithExponentialBackoff(f, {
  ...
  try {
    ...
    if (error instanceof Error && import_provider24.APICallError.isInstance(error) && error.isRetryable === true && tryNumber <= maxRetries) {
  ...
  return {
    ...
    async parseCompleteOutput({ text: text2 }, context2) {
      ...
      if (outerValue == null || typeof outerValue !== "object" || !("elements" in outerValue) || !Array.isArray(outerValue.elements)) {
        throw new NoObjectGeneratedError({
          message: "No object generated: response did not match schema.",
          cause: new import_provider25.TypeValidationError({
            value: outerValue,
...
var DefaultStreamTextResult = class {
      ...
      async pull(controller) {
        function abort() {
          ...
          controller.enqueue({
            ...
            ...(abortSignal == null ? void 0 : abortSignal.reason) !== void 0 ? { reason: (0, import_provider26.getErrorMessage)(abortSignal.reason) } : {}
          });
          controller.close();
        }
        try {
  ...
  toUIMessageStream({
    ...
    sendStart = true,
    sendFinish = true,
    onError = import_provider26.getErrorMessage
  } = {}) {
...
var arrayOutputStrategy = (schema) => {
  return {
    ...
    async validatePartialResult({
      ...
      var _a18;
      if (!(0, import_provider28.isJSONObject)(value) || !(0, import_provider28.isJSONArray)(value.elements)) {
        return {
          success: false,
...
var enumOutputStrategy = (enumValues) => {
  return {
    ...
    async validateFinalResult(value) {
      if (!(0, import_provider28.isJSONObject)(value) || typeof value.result !== "string") {
        return {
          success: false,
          error: new import_provider28.TypeValidationError({
            value,
...
async function parseAndValidateObjectResultWithRepair(result, outputStrategy, repairText, context2) {
  try {
    ...
    if (repairText != null && NoObjectGeneratedError.isInstance(error) && (import_provider29.JSONParseError.isInstance(error.cause) || import_provider29.TypeValidationError.isInstance(error.cause))) {
...
function simulateReadableStream({
  ...
  var _a18;
  const delay2 = (_a18 = _internal == null ? void 0 : _internal.delay) != null ? _a18 : import_provider_utils29.delay;
  let index = 0;
  return new ReadableStream({
    async pull(controller) {
...
function smoothStream({
  ...
  if (chunking != null && typeof chunking === "object" && "segment" in chunking && typeof chunking.segment === "function") {
    ...
    if (chunkingRegex == null) {
      throw new import_provider30.InvalidArgumentError({
        argument: "chunking",
...
function customProvider({
  ...
  return {
    ...
    languageModel(modelId) {
      ...
      throw new import_provider31.NoSuchModelError({ modelId, modelType: "languageModel" });
    },
    embeddingModel(modelId) {
      ...
      throw new import_provider31.NoSuchModelError({ modelId, modelType: "embeddingModel" });
    },
    imageModel(modelId) {
      ...
      throw new import_provider31.NoSuchModelError({ modelId, modelType: "imageModel" });
    },
    transcriptionModel(modelId) {
      ...
      throw new import_provider31.NoSuchModelError({ modelId, modelType: "transcriptionModel" });
    },
    speechModel(modelId) {
      ...
      throw new import_provider31.NoSuchModelError({ modelId, modelType: "speechModel" });
    },
    rerankingModel(modelId) {
      ...
      throw new import_provider31.NoSuchModelError({ modelId, modelType: "rerankingModel" });
    }
  };
}
...
var _a17;
var NoSuchProviderError = class extends import_provider32.NoSuchModelError {
  constructor({
    modelId,
    modelType,
    providerId,
  ...
  static isInstance(error) {
    return import_provider32.AISDKError.hasMarker(error, marker17);
  }
};
_a17 = symbol17;
...
var DefaultProviderRegistry = class {
  ...
  splitId(id, modelType) {
    ...
    if (index === -1) {
      throw new import_provider33.NoSuchModelError({
        modelId: id,
        modelType,
  ...
  languageModel(id) {
    ...
    if (model == null) {
      throw new import_provider33.NoSuchModelError({ modelId: id, modelType: "languageModel" });
    }
  ...
  imageModel(id) {
    ...
    if (model == null) {
      throw new import_provider33.NoSuchModelError({ modelId: id, modelType: "imageModel" });
    }
  ...
  speechModel(id) {
    ...
    if (model == null) {
      throw new import_provider33.NoSuchModelError({ modelId: id, modelType: "speechModel" });
    }
    return model;
  }
  rerankingModel(id) {
    ...
    if (model == null) {
      throw new import_provider33.NoSuchModelError({ modelId: id, modelType: "rerankingModel" });
    }
    return model;
  }
};
...
var NoTranscriptGeneratedError = class extends import_provider34.AISDKError {
  constructor(options) {
    super({
